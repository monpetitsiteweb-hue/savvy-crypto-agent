CREATE OR REPLACE FUNCTION public.settle_sell_trade_v2(p_mock_trade_id uuid, p_user_id uuid, p_strategy_id uuid, p_symbol text, p_sold_qty numeric, p_sell_price numeric, p_proceeds_eur numeric)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
  ...
  LOOP
    ...
    ELSE
      ...
      INSERT INTO mock_trades (
        ...
        true, 'onchain_settled_split', 'ONCHAIN',
