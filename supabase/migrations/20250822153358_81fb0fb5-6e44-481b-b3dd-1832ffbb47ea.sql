-- Update the mt_on_sell_snapshot trigger to handle symbol normalization properly
...
BEGIN
  ...
  -- Debug logging
  RAISE NOTICE 'TRIGGER: Processing sell for symbol % (normalized from %)', v_symbol, UPPER(TRIM(NEW.cryptocurrency));
