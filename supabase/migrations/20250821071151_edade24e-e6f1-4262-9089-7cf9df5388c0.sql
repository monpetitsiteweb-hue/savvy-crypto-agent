-- Fix remaining SECURITY DEFINER functions by ensuring proper search_path settings
-- Most of these functions legitimately need SECURITY DEFINER but must have secure search paths

-- Fix trigger function for price calculations
...
-- Fix trigger function for sell snapshots  
