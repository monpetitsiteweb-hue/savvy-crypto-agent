-- FIX 1: get_portfolio_metrics — déduire gas du total_pnl
-- AVANT: v_total_pnl := v_unrealized + v_realized (gas ignoré)
-- APRÈS: v_total_pnl := v_unrealized + v_realized - v_total_gas_eur
...
BEGIN
  ...
  -- FIX: Deduct gas from total P&L (v_total_gas_eur = 0 in TEST mode)
  -- =========================================================================
