-- Drop existing trigger and function, then recreate with correct FIFO logic
...
DROP FUNCTION IF EXISTS public.mt_on_sell_snapshot() CASCADE;

-- Recreate the SELL snapshot trigger exactly per your specifications
