  ...
  const copyAddress = () => {
    if (!systemWalletAddress) {
      toast({
        ...
        description: "System trading wallet is not configured for your account yet.",
        variant: "destructive",
      });
      return;
    }
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your system trading wallet address hasn’t been configured yet, so we can’t provide a deposit address.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Please contact support/admin to enable REAL funding for your account.
                  </p>
                </div>
              </div>
            </div>
