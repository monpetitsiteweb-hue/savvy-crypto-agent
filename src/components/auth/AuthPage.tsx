        ...
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-slate-700/50">
              <TabsTrigger 
                value="login" 
                className="text-slate-300 data-[state=active]:bg-green-500 data-[state=active]:text-white"
              >
                Login
              </TabsTrigger>
              <TabsTrigger 
          ...
          <Button 
            ...
            disabled={loading}
            variant="outline"
            className="w-full border-slate-600 bg-white text-slate-800 hover:bg-slate-50 hover:text-slate-900"
          >
            {loading ? (
          ...
          <Button 
            ...
            disabled={loading}
            variant="outline"
            className="w-full mt-3 border-slate-600 bg-[#1877F2] text-white hover:bg-[#166FE5]"
          >
            {loading ? (
              <Loader2 className="w-4 h-4 animate-spin mr-2" />
            ) : (
