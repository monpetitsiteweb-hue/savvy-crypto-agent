# Test Calibration Aggregator
# Generates calibration_metrics from decision_outcomes
...
$url = "https://$ProjectId.supabase.co/functions/v1/calibration-aggregator"
...
Write-Host "📈 Running calibration-aggregator..." -ForegroundColor Cyan
...
try {
    ...
    Write-Host ""
    Write-Host "Aggregation Results:" -ForegroundColor Yellow
